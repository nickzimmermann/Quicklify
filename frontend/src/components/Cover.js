    ...
    return(
        <div className="cover-wrapper" style={{
            ...
            <div className="banner-text ms-2" >
                ...
                <button type="button"  className="btn btn-primary text-center px-5" style={{"text-align": "center", "border-top": "1cm", "borderRadius": "4rem" , "height": "3rem"}}>{props.getstartedbtn}</button>
            </div>
        </div>
    )
};
